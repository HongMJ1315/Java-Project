...
public class Main extends JFrame implements ActionListener {
    ...
    public Main() {
        ...
        ImageIcon backgroundIcon = new ImageIcon("src/audio/basic/music.png");
        ...
        OscilloscopeButton = new JButton("進階");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == fileReaderButton) {
            ...
            JAppletFrame frame = new JAppletFrame("ShowWaves", scope);
